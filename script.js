...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('jan 01, 2026 00:00:00').getTime(),
...
const _slideEnam = function () {
  ...
  setTimeout(() => {
    document.getElementById("waBox").classList.remove("d-none");
  }, 3000);
};


new TypeIt("#teks1", {
  strings: ["Hai sayang. Selamat ulang tahun yaa.., aku langitkan semua doa terbaik buat kamu.", "Semoga hal-hal yang membuat kamu runtuh turut menjadi alasan kamu untuk tetap tumbuh.", "Semoga Allah senantiasa menjaga kamu dimanapun kamu berada.", "Semoga hari-hari kamu selalu diiringi cinta yang tak pernah ada batasnya." , "Semoga setiap langkahmu dimudahkan hingga tercapai apa yang kamu inginkan."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: ["Oh ya sayang waktu berlalu begitu cepat yaa... Semoga kamu selalu mendapatkan kebahagiaan bagimanapun caranya.", "Dan untuk hubungan kita juga aku berdoa agar di sampaikan ke jenjang pernikahan", "barakallah fi umrik sayang, terima kasih sudah bertahan sampai sejauh ini.", " ", "- Wish all you the best", "I LOVE YOU GAYUNGG"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
...
document.getElementById("sendWA").addEventListener("click", function () {
  ...
  const phone = "6281262778436"; // nomor tujuan WA

  if (text === "") {
    alert("Tulis pesannya dulu ya sayang 😊");
    return;
  }
